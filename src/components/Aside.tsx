...
function Aside() {
  const { user, isAuthenticate } = useAppSelector((state) => state.auth);
  return (
        ...
        <ul className="flex flex-col pl-0 mb-0">
          <li className="mt-0.5 w-full">
            <NavLink
              className={({ isActive }) =>
                `${
                  isActive && "from-purple-700 to-pink-500"
                } py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors`
              }
              to="/dashboard"
            >
              <div className="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-gray-500 bg-center stroke-0 text-center xl:p-2.5">
                <svg
                  width="12px"
                  height="12px"
                  viewBox="0 0 45 40"
          ...
          {user?.role === "ADMIN" && (
            <li className="mt-0.5 w-full">
              <NavLink
                ...
                to="/billing"
              >
                <div className="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-gray-500 bg-center fill-current stroke-0 text-center xl:p-2.5">
                  <svg
                    width="12px"
                    height="12px"
                    viewBox="0 0 43 36"
          ...
          <li className="mt-0.5 w-full">
            <NavLink
              className={({ isActive }) =>
                `py-2.7 text-sm shadow-soft-xl ${
                  isActive && "from-purple-700 to-pink-500"
                }  ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors`
              }
              to="/profile"
            >
              <div className="bg-gradient-to-tl shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-gray-500 bg-center stroke-0 text-center xl:p-2.5">
                <svg
                  width="12px"
                  height="12px"
                  viewBox="0 0 46 42"
        ...
        >
          ...
          <div className="relative z-20 flex-auto w-full p-4 text-left text-white">
            ...
            <div className="transition-all duration-200 ease-nav-brand">
              <h6 className="mb-0 text-white">Latest feature</h6>

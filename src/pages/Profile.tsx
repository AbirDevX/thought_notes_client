...
import AddProjectFrom from "../components/AddProjectFrom";
import ProfileNavbar from "../components/ProfileNavbar";
import Project from "../components/Project";
import { useAppSelector } from "../hooks/hooks";

function Profile() {
  const { user } = useAppSelector((sate) => sate.auth);
  ...
  return (
    <>
          ...
          <div className="flex flex-wrap -mx-3">
            ...
            <div className="flex-none w-auto max-w-full px-3 my-auto">
              <div className="h-full">
                <h5 className="mb-1 uppercase">{user?.name}</h5>
                <p className="mb-0 font-semibold leading-normal uppercase text-sm">
                  ROLE / {user?.role}
                </p>
              </div>
            </div>
      ...
      <div className="w-full p-6 mx-auto">
        {/* <div className="w-full px-6 mx-auto"> */}
        {showFrom && <AddProjectFrom setShowFrom={setShowFrom} />}
        {/* </div> */}
        <Project showFrom={showFrom} setShowFrom={setShowFrom} />
